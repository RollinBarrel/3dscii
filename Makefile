...
#---------------------------------------------------------------------------------
APP_TITLE 		:= 3DSCII
APP_AUTHOR 		:= RollinBarrel
APP_DESCRIPTION := Textmode drawing software for 3DS

RESOURCES	:=	resources
ICON		:=	$(RESOURCES)/icon.png
BANNER		:=	$(RESOURCES)/banner.png
AUDIO		:=	$(RESOURCES)/audio.ogg
...
CFLAGS  +=  -DTHREEDSCII_DEBUG -g3 -O0
endif

CXXFLAGS	:= $(CFLAGS) -Wno-psabi -fno-rtti -fno-exceptions -std=gnu++20
...
clean:
	@echo clean ...
	@rm -fr $(BUILD) $(TARGET).3dsx $(OUTPUT).smdh $(TARGET).elf $(OUTPUT).cia $(GFXBUILD)
